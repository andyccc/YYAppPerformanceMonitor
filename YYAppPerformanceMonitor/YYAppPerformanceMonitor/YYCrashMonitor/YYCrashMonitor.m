...
@implementation YYCrashMonitor

+ (YYCrashMonitor *)sharedMonitor {
    static YYCrashMonitor *sharedMonitor = nil;
...
void catch_exception_handle(NSException *exception) {
    ...
    [[YYMonitorDBManager sharedManager] deleteAllRecordWithType:YYAppMonitorDBTypeException];
    [[YYMonitorDBManager sharedManager] insertWithType:YYAppMonitorDBTypeException obj:exc];
    NSArray *arr = [[YYMonitorDBManager sharedManager] selectAllRecordWithType:YYAppMonitorDBTypeException];
